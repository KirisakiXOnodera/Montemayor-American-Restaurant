...
<body>
  ...
  <h1 class="title">FOOD <span> SEARCH</span></h1>

   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="Search food...">
      <input type="submit" name="search_btn" value="search" class="admin-btn">
   </form>
