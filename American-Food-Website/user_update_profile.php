...
<?php include 'header.php';?>
    ...
    <img class="profile-icon" src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="">
        <div class="flex">
            <div class="inputBox">
            <span>Username :</span>
            <input type="text" name="name"  value="<?= $fetch_profile['name']; ?>" placeholder="Change Username" class="box">
            <span>Email :</span>
            <input type="email" name="email"  value="<?= $fetch_profile['email']; ?>" placeholder="Change Email" >
            ...
            <input type="password" name="confirm_pass" placeholder="Enter Confirm Password"   >
            </div>
        </div>
